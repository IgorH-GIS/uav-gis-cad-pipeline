...
Project Overview:
This project demonstrates an end-to-end spatial data pipeline, transforming high-resolution UAV (drone) imagery into standardized, engineering-ready CAD deliverables and automated Python-based spatial reports. Based on a residential block in Sunderland, UK, the workflow highlights advanced topological digitization, strict GIS-CAD interoperability, and PyQGIS automation designed for high-volume Data-as-a-Service (DaaS) operations.

Core Technologies: QGIS, PyQGIS (Python), GeoPackage, LibreCAD, DXF.
Coordinate Reference System: EPSG:32630 (WGS 84 / UTM zone 30N).
